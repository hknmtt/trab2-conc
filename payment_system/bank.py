...
class Bank():
    ...
    #     """
    #     Esse método deverá bloquear uma conta bancária (Account) do banco.
    #     """
    #     self.accounts[account_id].lock()
    
    # def unlock_account(self, account_id: int) -> None:
    #     """
    #     Esse método deverá desbloquear uma conta bancária (Account) do banco.
    #     """
    #     self.accounts[account_id].unlock()
    ...
    def info(self) -> None:
        ...
        LOGGER.info(f"Reservas em {Currency.USD.name}: {self.reserves[Currency.USD]}")
        LOGGER.info(f"Reservas em {Currency.EUR.name}: {self.reserves[Currency.EUR]}")
        LOGGER.info(f"Reservas em {Currency.GBP.name}: {self.reserves[Currency.GBP]}")
        LOGGER.info(f"Reservas em {Currency.JPY.name}: {self.reserves[Currency.JPY]}")
        LOGGER.info(f"Reservas em {Currency.CHF.name}: {self.reserves[Currency.CHF]}")
        LOGGER.info(f"Reservas em {Currency.BRL.name}: {self.reserves[Currency.BRL]}")
